...
namespace ckm {
    ...
    public:
        ...
        void insertKeyframe(const keyframe_type& kf,
                            transition_type transIn);
        void insertKeyframeEquation(const keyframe_type& kf,
                                    equation_type& eq);
        ...
        bool calcPropertyAtTime(property_type& prop, CKTime time) const;

        const property_key_type& propertyId() const {
            return _propertyId;
        }

        CKTime startTime() const {
            return _startTime;
        }
