...
namespace ckm {
        ...
        _startTime(other._startTime)
    {
        ...
        other._startTime = CKTime(0);
    }

    template<typename _PropertyId, typename _Keyframe>
    auto  sequence<_PropertyId, _Keyframe>::sequence::operator=
          (sequence<_PropertyId, _Keyframe>&& other) ->
    ...
    template<typename _PropertyId, typename _Keyframe>
    void sequence<_PropertyId, _Keyframe>::insertKeyframe
    (
        const keyframe_type& kfToAdd,
    ...
    template<typename _PropertyId, typename _Keyframe>
    void sequence<_PropertyId, _Keyframe>::insertKeyframeEquation
    (
        const keyframe_type& kfToAdd,
        equation_type& eq
    )
    ...
    template<typename _PropertyId, typename _Keyframe>
    bool sequence<_PropertyId, _Keyframe>::calcPropertyAtTime
    (
        property_type& prop,
        CKTime time
    ) const
